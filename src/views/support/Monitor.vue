<template>
    <div>
        <el-carousel
                ...
                arrow="never"
                trigger="click"
                v-show="serviceArrs != null && serviceArrs.length > 0"
        >
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //在线文档 和 SQL监控 url赋值
            setUrlPath() {
                if (this.serviceArrs != null && this.serviceArrs.length > 0) {
                    this.onlineWordUrl =
                    ...
                    this.onlineWordUrl =
                        process.env.VUE_APP_URL + "/doc.html";
                    // console.log(this.onlineWordUrl);
                    this.sqlMonitorUrl =
                        process.env.VUE_APP_URL + "/druid/login.html";
                }
